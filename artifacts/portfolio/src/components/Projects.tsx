...
const projects = [
  {
    n: "01", title: "AI Resume Analyzer", type: "Feature",
  ...
  {
    n: "02", title: "AUTOSAR Config Tool", type: "Industry",
  ...
  {
    n: "03", title: "Real-Time Chat", type: "Side Project",
  ...
  {
    n: "04", title: "LLM Knowledge Assistant", type: "Experiment",
        ...
        >
          <div className="lg:col-span-7">
            <div className="flex items-center gap-3 mb-3">
              <motion.span
                className={`h-2 w-2 ${dotMap[feature.accent]}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-l border-t border-cream/30">
          {rest.map((p, i) => (
            ...
            >
              ...
              <motion.div
                className={`mt-4 h-1 ${accentBg[p.accent]} origin-left`}
                initial={{ scaleX: 0 }}
                whileHover={{ scaleX: 1 }}
